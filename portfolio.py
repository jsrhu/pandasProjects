...
"""
portfolio.py
Created on Fri Nov 18 13:51 2016
@author: jsrhu
"""
...
class Portfolio(object):
    ...
    def construct_all_positions(self):
        ...
        """
        d = dict( (k,v) for k, v in [(s, 0) for s in self.symbol_list] ) d[’datetime’] = self.start_date
        return [d]
    ...
    def construct_all_holdings(self):
        ...
        d[’cash’] = self.initial_capital d[’commission’] = 0.0
    ...
    def update_timeindex(self, event):
        ...
        # Update positions
        # ================
        dp = dict( (k,v) for k, v in [(s, 0) for s in self.symbol_list] ) dp[’datetime’] = latest_datetime
        ...
        dh[’commission’] = self.current_holdings[’commission’] dh[’total’] = self.current_holdings[’cash’]
        for s in self.symbol_list:
    ...
    def create_equity_curve_dataframe(self):
        ...
        """
        curve = pd.DataFrame(self.all_holdings) curve.set_index(’datetime’, inplace=True)
