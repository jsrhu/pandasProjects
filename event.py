...
class SignalEvent(Event):
    ...
    def __init__(self, strategy_id, symbol, datetime, signal_type, strength):
        ...
        """
        self.type = ’SIGNAL’ self.strategy_id = strategy_id self.symbol = symbol
...
class FillEvent(Event):
    ...
    def __init__(self, timeindex, symbol, exchange, quantity, direction, fill_cost, commission=None):
        """
        Initialises the FillEvent object. Sets the symbol, exchange, quantity, direction, cost of fill and an optional commission. If commission is not provided, the Fill object will calculate it based on the trade size and Interactive Brokers fees.
